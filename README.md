...
<body>
    ...
    <main class="container">
        ...
        <section id="makam-wali" class="grid">
            <h2>Makam Sapuro</h2>
            <img src="makam sapuro.jpeg" alt="Makam Sapuro">
        ...
        <section id="masjid" class="grid">
            ...
            <img src="masjid agung aljami pekalongan.jpeg" alt="Masjid Agung Al-Jami Pekalongan">
        ...
        <section id="majelis-keagamaan" class="grid">
            ...
            <img src="kanzus shalawat.jpeg" alt="Kanzus Shalawat">
